...
def US():
    Dict =  [ 'ace','airhead','ammo','antifreeze','armpit','barf','bashed','beemer','bench',
...
''' australiano slang leksiko'''
def AUS():
    Dict =  [ 'prawn','kayfa','goon','mate','legit','blunnies','barbie','footy','bogan','ravo','chigger',
...
''' canadeziko slang leksiko'''
def CAN():
    Dict = [ 'beaver','biffy','boonies','can'
...
''' eggleziko slang leksiko'''
def UK():
    Dict = [ 'Tosser','Cock-up','Bloody','Blimey','Wanker','Gutted','Bespoke','Chuffed'
